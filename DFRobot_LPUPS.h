...
#define UPS_PID_VALUE     0X42AA   //!< PID: 模块的PID (DFR0682)(最高两位作为种类判断00:SEN、01:DFR、10:TEL、11:BOS, 后面14位作为num)

/* LPUPS register address */
#define CS32_I2C_CHARGER_STATUS_REG   0x00U   //!< 21/20h
#define CS32_I2C_PROCHOT_STATUS_REG   0x02U   //!< 23/22h

#define CS32_I2C_ADC_PSYS_REG         0x06U   //!< 26h, PSYS:全范围:3.06 V, LSB 12 mV
#define CS32_I2C_ADC_VBUS_REG         0x07U   //!< 27h, VBUS:全范围:3.2 V - 19.52 V, LSB 64 mV
#define CS32_I2C_ADC_IDCHG_REG        0x08U   //!< 28h, IDCHG:全量程:32.512 A, LSB 256 mA
#define CS32_I2C_ADC_ICHG_REG         0x09U   //!< 29h, ICHG:全量程:8.128 A, LSB 64 mA
#define CS32_I2C_ADC_CMPIN_REG        0x0AU   //!< 2Ah, CMPIN:全量程:3.06 V, LSB 12 mV
#define CS32_I2C_ADC_IIN_REG          0x0BU   //!< 2Bh, POR状态- IIN:全量程:12.75 A, LSB 50 mA
#define CS32_I2C_ADC_VBAT_REG         0x0CU   //!< 2Ch, VBAT:全量程:2.88 V - 19.2 V, LSB 64 mV
#define CS32_I2C_ADC_VSYS_REG         0x0DU   //!< 2Dh, VSYS:全量程:2.88 V - 19.2 V, LSB 64 mV
